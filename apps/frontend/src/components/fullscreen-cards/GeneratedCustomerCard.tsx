...
export function GeneratedCustomerCard({
  ...
  return (
    <div
      className={`relative flex h-auto min-h-[420px] w-full max-w-[600px] lg:max-w-[700px] xl:max-w-[820px] shrink-0 flex-col overflow-hidden rounded-2xl border border-[#595854] bg-[#2A2A29] p-6 lg:p-8 shadow-2xl transition-all duration-300 ${
