...
export function GeneratedCustomerCard({
  ...
  return (
    <div
      className={`relative flex h-auto min-h-[420px] w-full max-w-[600px] lg:max-w-[700px] xl:max-w-[820px] shrink-0 flex-col overflow-hidden rounded-2xl border border-white/30 bg-[#222221] p-6 lg:p-8 shadow-2xl transition-all duration-300 ${
    ...
    >
      ...
      <div className="mb-4 lg:mb-6">
        <div className="flex items-start gap-3 lg:gap-4">
          {/* Profile Circle */}
          <div
            className={`flex h-12 w-12 lg:h-16 lg:w-16 shrink-0 items-center justify-center rounded-full border-2 border-white/40 text-base lg:text-lg font-bold text-white ${getColorFromName(customer.name)}`}
          >
